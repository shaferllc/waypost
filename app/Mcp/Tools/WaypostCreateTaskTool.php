...
#[Description('Creates a task on a project (POST /api/projects/{id}/tasks). Omit project_id to use the MCP default (set by waypost_create_project with scope_followup_to_new_project or waypost_set_active_project). Send title; optional body, status, version_id, theme_id, priority, due_date, planning_status, value_level, effort_level, eisenhower_quadrant, tags.')]
class WaypostCreateTaskTool extends Tool
{
    public function handle(Request $request): Response
    {
        ...
        return WaypostMcpApiResponse::fromDispatch('POST', '/projects/'.$projectId.'/tasks', [], $body);
    }
